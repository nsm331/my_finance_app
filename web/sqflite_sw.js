// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.13.1.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _rootFork($self, $parent, zone, specification, zoneValues) {
      ...
      if (specification != null) {
        _7_0 = specification.scheduleMicrotask;
        if (_7_0 != null)
          t1._scheduleMicrotask = new A._ZoneScheduleMicrotask(t1, _7_0);
        _12_0 = specification.handleUncaughtError;
        if (_12_0 != null)
          t1._handleUncaughtError = new A._ZoneHandleUncaughtError(t1, _12_0);
      }
      if (valueMap != null)
    ...
    runWithNativeMicrotasks(callback, $T) {
      ...
      return A.runZoned(callback, new A.ZoneSpecification(_null, _null, _null, _null, _null, _null, _null, _null, new A.runWithNativeMicrotasks_closure(new A.runWithNativeMicrotasks_addTask(callbackList, A._functionToJS0(new A.runWithNativeMicrotasks_runTasks(callbackList)))), _null, _null, _null, _null), _null, $T);
    },
      ...
      var $async$_handleBatch$3$continueOnError$noResult$operations = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 12:
              // default
              throw A.wrapException(A.UnsupportedError$("batch operation " + A.S(operation.method) + " not supported"));
            case 7:
              // after switch
            case 4:
              // for update
  ...
  A.SqfliteDatabaseFileSystemFfiWeb.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              try {
                t1 = $async$self.fs;
                t1 = t1.xAccess$2(t1.xFullPathName$1(path), 0);
                $async$returnValue = t1 !== 0;
                // goto return
                $async$goto = 1;
                break;
              } catch (exception) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.fs;
              fullPath = t1.xFullPathName$1(path);
              $async$goto = t1.xAccess$2(fullPath, 0) !== 0 ? 2 : 3;
              break;
            case 2:
              // then
              t1.xDelete$2(fullPath, 0);
              $async$goto = 4;
    ...
    readDatabaseBytes$1(path) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$next = [], $async$self = this, file, size, target, t1;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              t1 = $async$self.fs;
              file = t1.xOpen$2(new A.Sqlite3Filename(t1.xFullPathName$1(path)), 1)._0;
              try {
    ...
    _flush$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$self = this, t1, t2, exception, fs, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t2 = t1._currentWork;
              $async$goto = 8;
              return A._asyncAwait(t2 == null ? t1._startWorkingIfNeeded$1$isImplicit(false) : t2, $async$_flush$0);
            case 8:
              // returning from await.
              $async$handler = 1;
              // goto after finally
    ...
    writeDatabaseBytes$body$SqfliteDatabaseFileSystemFfiWeb(path, bytes) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], $async$next = [], $async$self = this, file, t1;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              // returning from await.
              t1 = $async$self.fs;
              file = t1.xOpen$2(new A.Sqlite3Filename(t1.xFullPathName$1(path)), 6)._0;
              $async$handler = 3;
              file.xTruncate$1(0);
      ...
      var $async$_startWorkingIfNeeded$1$isImplicit = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $async$self._currentWork == null && !$async$self._pendingWork.get$isEmpty(0) ? 2 : 3;
              break;
            case 2:
              // then
              ...
              $async$self._currentWork = result;
              $async$goto = 4;
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 59);
    var _;
    ...
    _instance(_, "get$xAccess", 0, 4, null, ["call$4"], ["xAccess$4"], 22, 0, 0);
    _instance(_, "get$xFullPathname", 0, 4, null, ["call$4"], ["xFullPathname$4"], 22, 0, 0);
    ...
    _instance(_, "get$xRead", 0, 4, null, ["call$4"], ["xRead$4"], 24, 0, 0);
    _instance(_, "get$xWrite", 0, 4, null, ["call$4"], ["xWrite$4"], 24, 0, 0);
    ...
    _instance_1_u(_, "get$xSectorSize", "xSectorSize$1", 14);
    _instance_1_u(_, "get$dispatchVoid", "dispatchVoid$1", 5);
    _instance_1_u(_, "get$dispatchInt", "dispatchInt$1", 58);
    _instance(_, "get$dispatchUpdateHook", 0, 5, null, ["call$5"], ["dispatchUpdateHook$5"], 89, 0, 0);
    _instance(_, "get$dispatchXFunc", 0, 4, null, ["call$4"], ["dispatchXFunc$4"], 15, 0, 0);
    _instance(_, "get$dispatchXStep", 0, 4, null, ["call$4"], ["dispatchXStep$4"], 15, 0, 0);
    _instance(_, "get$dispatchXInverse", 0, 4, null, ["call$4"], ["dispatchXInverse$4"], 15, 0, 0);
    ...
    _instance_2_u(_, "get$dispatchApplyFilter", "dispatchApplyFilter$2", 88);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(JSObject)", "~(int)", "Future<@>()", "~(~())", "int(VirtualFileSystemFile,int)", "~(@)", "~(@,@)", "Null(JSObject)", "Future<~>(_IndexedDbTransaction)", "Future<~>()", "Future<Null>()", "Future<@>(SqfliteFfiDatabase)", "int(VirtualFileSystemFile)", "~(RegisteredFunctionSet,int,int,int)", "@()", "~(RegisteredFunctionSet,int)", "Null(@)", "Future<Object?>()", "int(VirtualFileSystem,int)", "Future<Map<@,@>>()", "int(VirtualFileSystem,int,int,int)", "Null(Object,StackTrace)", "int(VirtualFileSystemFile,int,int,JavaScriptBigInt)", "Future<bool>()", "Future<int?>()", "Future<int>()", "bool(String)", "String(String?)", "Map<String,Object?>(SqfliteFfiException)", "~(@[@])", "SqfliteFfiException(@)", "String?(Object?)", "Map<@,@>(int)", "~(Map<@,@>)", "~(int,@)", "Future<Object?>(SqfliteFfiDatabase)", "Future<int?>(SqfliteFfiDatabase)", "Future<int>(SqfliteFfiDatabase)", "int(int)", "~(FfiMethodResponse)", "~(Object,StackTrace)", "MapEntry<String,_BigIntAdapter>(int,_BigIntAdapter)", "String(Object?)", "Null(~())", "~(Zone,ZoneDelegate,Zone,~())", "~(JavaScriptBigInt,int)", "VirtualFileSystemFile?(VirtualFileSystem,int,int,int,int)", "int(VirtualFileSystem,int,int)", "int?()", "int(VirtualFileSystem?,int,int)", "@(@)", "int?(String)", "0&(String,int?)", "int(VirtualFileSystemFile,JavaScriptBigInt)", "@(@,String)", "int(VirtualFileSystemFile,int,int)", "int(int())", "String(String)", "~(Object?,Object?)", "Null(@,StackTrace)", "int(RegisteredFunctionSet,int,int,int,int)", "int(int(int),int)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "int(SessionApplyCallbacks,int,int)", "@(String)", "JSObject()", "int(int,int)", "JSObject(JSObject?)", "~(ByteBuffer)", "Future<~>(int,Uint8List)", "Future<~>(int)", "Uint8List()", "int(@,@)", "bool(Object?)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "int(SessionApplyCallbacks,int)", "~(~(int,String,int),int,int,int,JavaScriptBigInt)"],
...
;
    ...
    B.Map_empty0 = new A.ConstantStringMap(B.Object_empty, [], A.findType("ConstantStringMap<Object?,Object?>"));
    B._ZoneValues__RootZone_Map_empty = new A._ZoneValues(B.C__RootZone, B.Map_empty0);
  })();
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_storesJs", "$get$_storesJs", () => A.ListToJSArray_get_toJS(A._setArrayType([A.StringToJSString_get_toJS("files"), A.StringToJSString_get_toJS("blocks")], type$.JSArray_String), type$.String));
  })();
